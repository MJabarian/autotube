...
class WhisperAudioSynchronizer:
    ...
    def determine_shot_type(self, content_type: str, image_number: int, previous_shot_types: List[str]) -> str:
        ...
        Args:
            ...
            image_number: Current image number (1-20)
    ...
    async def analyze_and_generate_prompt(
        ...
        try:
            ...
            async with StoryGenerator() as generator:
                ...
                IMAGE NUMBER: {image_number} (out of 20)
                ...
                - Late images (18-20): Prefer close_up and emotional shots
                - Avoid repeating same shot type 3+ times in a row
                ...
                - Maintains Baroque/1970s gangster film aesthetic
    ...
    def _fallback_parse_response(self, response_text: str, audio_content: str) -> Dict[str, str]:
        ...
        image_prompt = f"Cinematic {shot_type} of {audio_content}, highly detailed Baroque painting style with dramatic chiaroscuro lighting, expressive faces, sharp shadows, warm candlelit interiors, Rembrandt-style intensity"
    ...
    def _fallback_analysis(self, audio_content: str, story_context: str, image_number: int, previous_shot_types: List[str]) -> Dict[str, str]:
        ...
        image_prompt = self._generate_template_prompt(audio_content, content_type, shot_type)
    ...
    def _generate_template_prompt(self, audio_content: str, content_type: str, shot_type: str) -> str:
        ...
        prompt += "highly detailed cinematic illustration in the style of a Baroque painting fused with 1970s gangster films, "
        prompt += "dramatic chiaroscuro lighting, expressive faces, sharp shadows, warm candlelit interiors, "
        prompt += "Rembrandt-style intensity, hyper-realistic but stylized characters, painterly texture"
