...
class OptimizedPromptEnhancer:
    ...
    def __init__(self):
        ...
        self.core_style = (
            "highly detailed cinematic illustration with dramatic lighting and atmosphere, "
...
class OptimizedReplicateImageClient:
    ...
    def _load_style_enhancer(self) -> str:
        ...
        try:
            ...
            return (
                "highly detailed cinematic illustration with dramatic lighting and atmosphere, "
                "expressive faces, sharp shadows, atmospheric interiors, "
                "hyper-realistic but stylized characters, consistent facial proportions, "
